...
export default function Home(): JSX.Element {
  return (
    <Layout description="React Native Reanimated is a powerful animation library that makes it easy to create smooth animations and interactions that run in the UI thread.">
