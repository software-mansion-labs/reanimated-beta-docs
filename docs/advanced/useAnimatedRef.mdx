...
`useAnimatedRef` lets you get a reference of a view. Used alongside [`measure`](/docs/advanced/measure), `scrollTo`, or `useScrollViewOffset` function.

An object defined using `useAnimatedRef` have to be passed to the `ref` property of a component.
