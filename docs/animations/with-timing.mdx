...
The timing animation configuration. Available properties:

- `duration`: length of the animation (in milliseconds). Defaults to 300.
- `easing`: an easing function which defines the animation curve. Defaults to `Easing.inOut(Easing.quad)`.
