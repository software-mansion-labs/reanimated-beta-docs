...
Animated components are components which Reanimated can animate. Reanimated comes with just a handful of built-in components like `Animated.View`, `Animated.ScrollView`, or `Animated.ScrollView`. For components which aren't a part of Reanimated, to make their props animatable, you wrap them with [`createAnimatedComponent`](/docs/core/createAnimatedComponent):
