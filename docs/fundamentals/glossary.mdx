...
For components which aren't a part of Reanimated, to make their props animatable, you wrap them with [`createAnimatedComponent`](/docs/core/createAnimatedComponent):
