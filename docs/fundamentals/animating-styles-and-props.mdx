...
Now that we know how to use Shared Values and create basic animations we're more than ready to learn a different way of passing animation styles to elements. We'll also about the differences between animating styles and props and how to handle them both.
