...
Make sure to check check the full [`withDecay` API reference](http://localhost:3000/docs/animations/withDecay) to get to know rest of the configuration options.
