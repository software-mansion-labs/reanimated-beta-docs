...
<CollapsibleCode showLines={[9, 29]} src={Repeat} />
...
<CollapsibleCode showLines={[18, 36]} src={Sequence} />

## Using `withDecay`

import Decay from "!!raw-loader!@site/src/examples/ApplyingModifiers/Decay";

<CollapsibleCode showLines={[19, 40]} src={Decay} />
