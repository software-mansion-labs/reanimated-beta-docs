...
The spring animation configuration. Available properties:
...
| **velocity** <br/>_(optional)_                   | `number`  | 100     | Initial velocity applied to the spring equation.                                                          |
...
<details>
<summary><b><code>config</code> playground</b></summary>
